...
from scvi.data.fields import (CategoricalJointObsField, CategoricalObsField,
                              ...
                              NumericalObsField)
from scvi.distributions import (NegativeBinomial, Normal,
...
class BulkVAEModule(BaseModuleClass):
    ...
    def generative(
        ...
        from scvi.distributions import (NegativeBinomial, Normal, Poisson,
                                        ZeroInflatedNegativeBinomial)
        from torch.nn.functional import linear
