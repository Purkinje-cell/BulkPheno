...
# +
# allowable_features['possible_chirality_list'].index(Chem.rdchem.ChiralType.CHI_UNSPECIFIED)
# -
...
def mol_to_graph_data_obj_simple(mol):
    ...
    atom_features_list = []
    for atom in mol.GetAtoms():
#         print(1, allowable_features['possible_chirality_list'])
#         print(2, atom.GetChiralTag())
...
#                         data = mol_to_graph_data_obj_simple(rdkit_mol)
                        data = mol_to_data_obj(rdkit_mol)
                        # manually add mol id
